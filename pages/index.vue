            ...
            <div class='card bg-base-100 w-full shadow-xl h-80'>
              <div class='card-body'>
                <div class='flex flex-col text-left' ref='copyContent'>
                  ...
                  <!-- Website -->
                  <div>
                    <a :href='`https://${signature.website.src}`' class='link link-primary'>{{ signature.website.name
                      }}</a>
                  </div>
                  <!-- Email -->
                  <div>
          ...
          <div class='col-span-2'>
            <div class='card bg-base-100 w-full shadow-xl p-5 space-y-4 h-80'>
              <div class='flex justify-between'>
                ...
                <button class='btn btn-primary' @click='copyClipboardHtml'>Copy in html</button>
                <button class='btn btn-primary' @click='copyClipboardPlain'>Copy in plain</button>
              </div>
          ...
          <div class='card bg-base-100 w-full shadow-xl p-5'>
            ...
            <div class='card-body'>
              <div class='grid grid-cols-3 gap-8'>
                ...
                <signature-input id='signature_name' title='Name' type='text'
                  v-model='signature.name'></signature-input>

                <signature-input id='signature_title' title='Title' type='text'
                  v-model='signature.title'></signature-input>
...
export default {
  ...
  methods: {
    /**
     * Copy Signature code into clipboard with html tags
     */
    copyClipboardHtml() {
    ...
    /**
     * Copy Signature code into clipboard as plain text
     */
    copyClipboardPlain() {
      navigator.clipboard.writeText(this.$refs.copyContent.innerText)
    }
  },
}
</script>